...
write.xlsx(survival_model4, file.path(survival_output_directory_data, "canine-survival_model_params-toc_vs_lis.xlsx"))
...
write.xlsx(survival_model5, file.path(survival_output_directory_data, "canine-survival_model_params-toc_vs_dox.xlsx"))
